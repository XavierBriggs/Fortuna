...
- **Status:** WS1 kicked off. Slices sealed: 8 of 9 (+ slice-7 synthesis-cold regression caught & fixed). Next: WS1 slice 8b (Brier gate) — LAST slice, then WS1-boundary hard verify.
