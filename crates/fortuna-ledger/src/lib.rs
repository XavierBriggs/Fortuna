...
pub use repos::{
    ...
    JournalRow, LessonRow, LessonsRepo, PersonaRow, PersonasRepo, RecentSignalRow,
    ReservationsRepo, ResolvedPersonaStats, ResolvedStat, ScalarBeliefRow, ScalarBeliefsRepo,
